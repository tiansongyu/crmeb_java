...
public class StoreOrderInfoResponse implements Serializable {
    ...
    @ApiModelProperty(value = "线下付款提交时间")
    private Date offlinePaySubmitTime;

    @ApiModelProperty(value = "线下付款审核时间")
    private Date offlinePayAuditTime;

    @ApiModelProperty(value = "线下付款审核管理员ID")
    private Integer offlinePayAuditAdminId;
